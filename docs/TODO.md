...
### P8. BenefitReceipt UI 텍스트·레이아웃 개선 (2026-04-19, TDD)

> 사용자가 영수증 기능의 목적을 명확히 인지할 수 있도록 텍스트 및 레이아웃 조정.
> 디자인 구조·API·Props 변경 없이 텍스트와 CSS만 수정.

- [v] **[P8-1] 상단 레이블 "SMARTPICK RECEIPT" → "예상 최대 혜택 영수증"**
- [v] **[P8-2] 날짜/번호 → 안내 문구 2줄로 교체 + 왼쪽 하단 정렬**
  - "입력하신 소비 예산 기반으로 계산된 최대 혜택입니다" (줄바꿈) "실제 소비액에 따라 달라질 수 있습니다."
- [v] **[P8-3] 구분선 위 안내 문구 추가** — 옅은 보라색, 소형 글자
  - "원하는 혜택만 선택하여 다시 추천받을 수 있어요"
- [v] **[P8-4] 재추천 버튼 텍스트 변경** — "선택한 혜택 기반 재추천" → "선택한 혜택으로 다시 추천받기"
- [v] **[P8-5] 재추천 버튼 높이 축소** — `h-14` → `h-11`
- [v] **[P8-6] 닫기 버튼 → 우상단 X 버튼으로 이동** (하단 닫기 버튼 제거, dim 클릭 닫힘 유지)
